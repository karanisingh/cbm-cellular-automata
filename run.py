...
if __name__ == "__main__":
    ...
    parser.add_argument("--device-input-path", type=str, required=True , help="Path to input device board")
    parser.add_argument("--output-path", type=str, default="./data/output/", help="Path to save video to")
    parser.add_argument("--device-param1", type=float, required=True , help="Device Parameter 1 (RECOMMENDED=0.5)")
    parser.add_argument("--device-param2", type=int, required=True , help="Device Parameter 2 (RECOMMENDED=2)")
